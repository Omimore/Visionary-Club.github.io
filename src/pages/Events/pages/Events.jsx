    ...
    const eventData = [
        {
            ...
            //image: "/Events/techfest/IMG-20250321-WA0003.jpg",
            images: [
               // "/Events/hackthon23/_DSC5650.JPG",
                //"/Events/hackthon23/_DSC5793.JPG",
                //"/Events/techfest/IMG-20250321-WA0004.jpg",
            ],
            highlights: [
        ...
        },
        {
            ...
            image: `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5611.JPG`,
            images: [
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5638.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5638.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5657.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5664.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5674.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5748.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/20231106_44859pmByGPSMapCamera.jpg`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5718.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5725.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5731.JPG`,
                `${process.env.PUBLIC_URL}/Events/hackthon23/_DSC5735.JPG`,
            ],
            highlights: [
        ...
        },
        {
            ...
            image: `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0003.jpg`,
            images: [
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0003.jpg`,
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0004.jpg`,
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0005.jpg`,
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0006.jpg`,
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0007.jpg`,
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0008.jpg`,
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0009.jpg`,
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0010.jpg`,
                `${process.env.PUBLIC_URL}/Events/techfest/IMG-20250321-WA0011.jpg`,
